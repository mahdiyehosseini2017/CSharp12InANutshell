...
public class Program
{
    public void Main()
    {
        //var foo = new Foo(1, 2) { Optional1 = 3 };

        // var point = new Point(1, 2);
        // point.X = 7;  //X is init-only property

        // var point = new Point(1, 2);
        // point.X = 7;  //When you define a parameter list in a record struct, the compiler emits
        //               //writable properties instead of init-only properties,

        //var point = new Point(1, 2);
        // point.X = 7; //X is init-only property in a parameter list readonly record struct
    }
}
